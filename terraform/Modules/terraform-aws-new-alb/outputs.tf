...
output "target_group_arns" {
  ...
  value = slice(
    concat(
      module.tg_main_no_logs.target_group_arns,
      module.tg_main.target_group_arns
    ),
    0,
...
output "target_group_arn_suffixes" {
  ...
  value = slice(
    concat(
      module.tg_main_no_logs.target_group_arn_suffixes,
      module.tg_main.target_group_arn_suffixes
    ),
    0,
    var.target_groups_count,
  )
...
output "target_group_names" {
  ...
  value = slice(
    concat(
      module.tg_main_no_logs.target_group_names,
      module.tg_main.target_group_names
    ),
    0,
    var.target_groups_count,
  )
